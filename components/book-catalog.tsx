...
const booksData: Book[] = [
  {
    ...
    description:
      "Novel tentang perjuangan anak-anak di Belitung untuk mendapatkan pendidikan yang layak.",
  },
  {
    id: 2,
    title: "Bumi Manusia",
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Novel sejarah yang mengisahkan perjuangan seorang pribumi terpelajar pada masa kolonial Belanda.",
  },
  {
    id: 3,
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Buku tentang filsafat Stoisisme yang diaplikasikan dalam kehidupan modern.",
  },
  {
    id: 4,
    title: "Pulang",
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Novel yang mengisahkan perjalanan hidup seorang anak yang terpaksa menjadi pembunuh bayaran.",
  },
  {
    id: 5,
    title: "Perahu Kertas",
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Novel tentang kisah cinta dan persahabatan antara Kugy dan Keenan.",
  },
  {
    id: 6,
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Novel inspiratif tentang kehidupan di pesantren dan mimpi untuk menggapai dunia.",
  },
  {
    id: 7,
    title: "Sang Pemimpi",
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Sekuel dari Laskar Pelangi yang mengisahkan perjuangan Ikal dan Arai untuk menggapai mimpi.",
  },
  {
    id: 8,
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Novel islami yang mengisahkan kehidupan cinta seorang mahasiswa Indonesia di Mesir.",
  },
  {
    id: 9,
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Novel tentang kisah cinta remaja SMA di Bandung pada tahun 1990.",
  },
  {
    id: 10,
    title: "Hujan",
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Novel fiksi ilmiah yang mengisahkan tentang persahabatan dan cinta di masa depan.",
  },
  {
    id: 11,
    title: "Rentang Kisah",
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Memoar tentang perjalanan hidup Gita Savitri Devi selama menempuh pendidikan di Jerman.",
  },
  {
    id: 12,
    ...
    coverImage: "/placeholder.svg?height=250&width=180",
    description:
      "Buku pengembangan diri yang mengajarkan cara memilih hal-hal yang penting dalam hidup.",
  },
];
...
export default function BookCatalog() {
  ...
  useEffect(() => {
    ...
    if (yearFilter && yearFilter !== "all") {
      filteredBooks = filteredBooks.filter(
        (book) => book.year === Number.parseInt(yearFilter)
      );
    }
  ...
  const confirmRequestLoan = async () => {
    ...
    try {
      ...
      setActiveLoans([
        ...activeLoans,
        { bookId: selectedBook.id, status: "PENDING" },
      ]);
      ...
      toast.error(
        error instanceof Error ? error.message : "Gagal mengajukan peminjaman"
      );
    } finally {
    ...
    <Card className="overflow-hidden transition-all hover:shadow-md">
      ...
      <CardContent className="px-4 pb-2">
        <div className="flex flex-wrap gap-2">
          <Badge className="bg-blue-50 text-blue-700">{book.category}</Badge>
          <Badge className="bg-gray-50 text-gray-700">{book.year}</Badge>
        </div>
