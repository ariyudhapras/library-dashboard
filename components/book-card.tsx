...
export function BookCard({ book, onRequestLoan, isWishlisted = false }: BookCardProps) {
      ...
      <CardFooter className="p-4 flex flex-col gap-2">
        {isAlreadyBorrowed ? (
          <Button 
            ...
            variant="outline" 
            disabled
            aria-label="Buku sudah dipinjam"
          >
          ...
          <Button 
            ...
            aria-label={book.stock > 0 ? "Ajukan peminjaman buku" : "Stok buku habis"}
          >
            {isLoading ? (
              <>
        ...
        {/* Wishlist Button below Ajukan Pinjam, only if user is logged in */}
        {session?.user && (
