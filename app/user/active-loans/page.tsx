                    ...
                    <TableBody>
                      {filteredLoans.map((loan) => (
                        <TableRow key={loan.id}>
                          ...
                          <TableCell>
                            {(loan.status === 'APPROVED' || loan.status === 'LATE') && (
                              <Button 
                                variant="outline" 
                                size="sm"
      ...
      <AlertDialog open={returnDialogOpen} onOpenChange={setReturnDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin mengembalikan buku "{selectedLoan?.book.title}"?
              {new Date() > new Date(selectedLoan?.returnDate || '') && (
                <p className="mt-2 text-red-500">
                  Buku ini terlambat dikembalikan. Anda mungkin dikenakan denda sesuai kebijakan perpustakaan.
                </p>
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
